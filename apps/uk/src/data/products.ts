...
export const muuhuComb: Product = {
  ...
  slug: "muuhu-comb",
  template: "torch",
  name: "Muuhu Scalp Therapy Brush",
  heroTitle: "Muuhu",
  heroEmphasis: "Comb",
  shortDescription:
    "3-in-1 Red Light Scalp Care & Massage Comb with micro-vibration, red light therapy, and integrated liquid serum applicator.",
  description:
    "Transform your hair and scalp health with the Muuhu Scalp Therapy Brush. Combining 650nm red light therapy, therapeutic micro-vibrations, and an integrated serum dispensing tank, this 3-in-1 tool revitalises hair follicles, boosts blood circulation, and delivers nourishing oils directly to your roots without mess or grease.",
  seoTitle: "Muuhu Scalp Therapy Brush | 3-in-1 Red Light Scalp Care & Massage UK",
  seoDescription:
    "Shop the Muuhu Scalp Therapy Brush in the UK. 3-in-1 hair growth comb featuring 650nm red light therapy, micro-vibration massage, and precision serum delivery.",
  currency: market.currency,
  priceCents: 7900,
  ...
  highlights: [
    "650nm Red light therapy stimulates hair follicles & promotes root strength",
    "High-frequency micro-vibrations soothe scalp tension & boost circulation",
    "Integrated serum applicator delivers oils & treatments directly to the roots",
  ],
  cartImage: "/images/products/muuhu-comb/muuhu-hair-growth-therapy-comb-hero.webp",
  gallery: [
    {
      src: "/images/products/muuhu-comb/muuhu-hair-growth-therapy-comb-hero.webp",
      alt: "Muuhu Scalp Therapy Brush 3-in-1 Red Light Comb",
    },
    {
      src: "/images/products/muuhu-comb/muuhu-red-light-therapy-benefits.webp",
      alt: "650nm Red Light Phototherapy Follicle Stimulation",
    },
    {
      src: "/images/products/muuhu-comb/muuhu-essential-oil-applicator-comb.webp",
      alt: "Precision Serum & Essential Oil Applicator Tank",
    },
    {
      src: "/images/products/muuhu-comb/muuhu-vibrating-scalp-therapy.webp",
      alt: "High-Frequency Micro-Vibration Scalp Massage",
    },
    {
      src: "/images/products/muuhu-comb/muuhu-hair-growth-comb-waterproof.webp",
      alt: "IPX5 Water Resistant & Easy Rinse Design",
    },
    {
      src: "/images/products/muuhu-comb/muuhu-hair-growth-comb-features.webp",
      alt: "Multi-Functional Scalp Care & Root Care Technology",
    },
    {
      src: "/images/products/muuhu-comb/muuhu-scalp-care-routine.webp",
      alt: "Daily Haircare & Scalp Treatment Routine",
    },
    {
      src: "/images/products/muuhu-comb/muuhu-comb-charging-usb.webp",
      alt: "Type-C USB Rechargeable Long-Life Battery",
    },
    {
      src: "/images/products/muuhu-comb/muuhu_24.webp",
      alt: "Daily Scalp Treatment Mirror Routine",
    },
    {
      src: "/images/products/muuhu-comb/muuhu_25.webp",
      alt: "Relaxing Phototherapy Scalp Massage",
    },
    {
      src: "/images/products/muuhu-comb/muuhu-comb-before-after-2.webp",
      alt: "Before & After Results with Muuhu Comb",
    },
  ],
  specs: [
    { label: "Light Therapy", value: "650nm Red Light Phototherapy" },
    { label: "Vibration", value: "High-Frequency Micro-Vibration Massage" },
    { label: "Liquid Tank", value: "Integrated Serum & Essential Oil Applicator" },
    { label: "Waterproof", value: "IPX5 Water Resistant" },
    { label: "Power & Charging", value: "USB Fast Charging, Long-Lasting Battery" },
    { label: "Design", value: "Ergonomic Handheld Grip" },
  ],
  faqs: [
    {
      question: "How does the red light therapy help hair growth?",
      answer:
        "The targeted 650nm red light penetrates deep into the scalp to energise cellular mitochondria, stimulate microcirculation, and encourage dormant follicles to support thicker, healthier-looking hair.",
    },
    {
      question: "Can I use it with any hair serum or essential oil?",
      answer:
        "Yes, the built-in liquid tank works with all hair oils, minoxidil, and scalp serums, dispensing liquid evenly through the comb teeth directly to the roots without greasy residue.",
    },
    {
      question: "Is the comb waterproof and easy to clean?",
      answer:
        "Yes, it features an IPX5 water-resistant design. Simply rinse the comb teeth and tank under warm tap water after each session. Do not submerge the charging port.",
    },
    {
      question: "How often should I use the Muuhu Comb?",
      answer:
        "We recommend using it 3 to 5 times weekly for 5–10 minutes per session on clean, dry hair.",
    },
  ],
  gifts: [],
  included: [
    {
      label: "Muuhu Scalp Therapy Brush",
      quantity: 1,
      image: "/images/products/muuhu-comb/muuhu-hair-growth-therapy-comb-hero.webp",
    },
    {
      label: "Integrated Serum Applicator Tank",
      quantity: 1,
  ...
  badges: ["CE Certified", "Red Light Therapy", "Micro-Vibration", "IPX5 Waterproof"],
};
