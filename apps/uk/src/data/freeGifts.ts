    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "It supports the same premium feeling you see on the product page: clean presentation, organised accessories, and a styling system that feels ready from day one.",
        ],
        bullets: [
