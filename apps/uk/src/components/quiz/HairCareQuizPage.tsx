...
import { emptyHairCareAnswers, hairCareQuestions } from "@/data/hairQuiz";
import { buildHairCareResult } from "@/lib/hairQuiz";

export function HairCareQuizPage() {
  return (
    <section className="buudy-section bg-[var(--cream)] py-12 md:py-18 lg:py-24">
      ...
      <div className="buudy-wrap relative z-10">
        <div className="mb-10 max-w-3xl md:mb-14">
          <p className="buudy-eyebrow">Personalised haircare</p>
          <h1 className="buudy-display mt-4 text-[3rem] leading-[.98] text-[var(--plum)] md:text-[5.4rem]">
            Your hair, mapped to a{" "}
            <em className="buudy-italic text-[var(--gold)]">better ritual</em>.
          </h1>
          <p className="buudy-copy mt-5 max-w-2xl">
            A 60-second assessment for a repair and protection routine, shaped
            around your hair type, concerns, and daily habits.
          </p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[.82fr_1.18fr] lg:items-start">
          <aside className="lg:sticky lg:top-8">
            <div className="relative aspect-[4/5] overflow-hidden rounded-[18px] bg-[var(--plum)]">
              <Image
                alt="Muuhu Hair Dryer prep routine"
                className="object-cover"
                fill
                priority
                sizes="(min-width: 1024px) 38vw, 92vw"
                src="/images/products/muuhu-hair-dryer/07-prep-hair.webp"
              />
              <div className="absolute inset-x-0 bottom-0 bg-[linear-gradient(180deg,transparent,rgba(23,10,24,.88))] p-6 pt-24 text-[var(--cream)]">
                <p className="buudy-mono text-[var(--gold)]">7 attachments, one tool</p>
                <p className="buudy-display mt-2 text-3xl leading-tight">
                  A routine that meets your hair where it is.
                </p>
              </div>
            </div>
          ...
          <HairQuizFlow
            track="care"
            storageKey="muuhu:haircare-quiz:v1"
            emptyAnswers={emptyHairCareAnswers}
            questions={hairCareQuestions}
            buildResult={buildHairCareResult}
            productHref="/products/muuhu-hair-dryer"
            ctaCopy="Get the Muuhu 7-in-1 Hair Dryer and unlock your full 4-week plan, with advanced styling and your signature look."
            ctaLabel="Get the Hair Dryer"
            intro={{
              eyebrow: "60-second assessment",
              title: "Build your custom",
              titleAccent: "routine.",
              copy: "Discover the exact attachment, heat setting, and weekly plan your hair needs, based on your concerns and goals.",
