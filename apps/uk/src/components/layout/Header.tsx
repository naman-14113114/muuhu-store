              ...
              >
                ...
                <div className="p-2">
                  {signedIn ? (
                    ...
                    <>
                      <HeaderMenuLink href="https://muuhu.com/sign-in" label="Sign in" />
                      <HeaderMenuLink href="https://muuhu.com/sign-up" label="Sign up" />
                    </>
                  )}
                </div>
              </div>
                ...
                <div className="flex-1 px-4 py-5">
                  ...
                  <div className="mt-2">
                    {signedIn ? (
                      ...
                      <>
                        <MobileMenuLink
                          href="https://muuhu.com/sign-in"
                          label="Sign in"
                          onClick={() => setMobileMenuOpen(false)}
                        />
                        <MobileMenuLink
                          href="https://muuhu.com/sign-up"
                          label="Sign up"
                          onClick={() => setMobileMenuOpen(false)}
                        />
                      </>
