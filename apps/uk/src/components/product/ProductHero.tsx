  ...
  return (
    ...
    >
      ...
      <div className="buudy-wrap relative z-10 grid gap-8 [overflow-anchor:none] lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1fr)] lg:items-start lg:gap-8 xl:grid-cols-[1.05fr_1fr] xl:gap-16">
        <div className={isComb ? "" : "lg:sticky lg:top-6 lg:self-start"}>
          <ProductGallery images={product.gallery} hasGifts={product.gifts.length > 0} badgePosition={isComb ? "top-right" : "bottom-right"} />
        </div>
        <div className={`[overflow-anchor:none] ${isComb ? "lg:sticky lg:top-6 lg:self-start" : ""}`}>
