          ...
          {productHandle === "buudy-led-mask" && (
            <article className="rounded-[28px] border border-[var(--border)] bg-[var(--card)] p-6 shadow-[0_18px_50px_rgba(39,20,42,.08)] md:p-7">
              ...
              <p className="mt-5 text-base leading-8 text-[var(--muted)]">
                ...
                830nm near-infrared, so one device can support red light
                firmness routines, blue light breakout routines, tone-balancing
                modes, and deeper near-infrared sessions. Unlike face-only
                masks, Buudy covers the jawline and neck, which matters because
                the neck often shows visible ageing early. It is cordless,
                rechargeable, and controlled with a simple tap system, making
                consistent at-home use easier than clinic appointments or wired
                masks. The current UK launch offer is £179 with a £449
                compare-at price, free tracked UK shipping, a free glow kit
                while available, and a 90-day money-back guarantee.
              </p>
            </article>
          )}
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <span
                      className={`mt-1 grid h-9 w-9 flex-none place-items-center rounded-full border border-[rgba(184,149,86,.24)] bg-[rgba(184,149,86,.10)] text-[var(--gold)] transition ${
                        isOpen ? "rotate-45 bg-[rgba(184,149,86,.16)]" : ""
                      }`}
                    >
                      <IconPlus aria-hidden="true" size={20} stroke={1.55} />
                    </span>
                  </button>
                  <div
