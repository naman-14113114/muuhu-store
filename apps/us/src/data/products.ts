...
export const muuhuComb: Product = {
  ...
  description:
    "Transform your hair and scalp health with the Muuhu Scalp Therapy Brush. Combining 650nm red light therapy, therapeutic micro-vibrations, and an integrated serum dispensing tank, this 3-in-1 tool revitalizes hair follicles, boosts blood circulation, and delivers nourishing oils directly to your roots without mess or grease.",
  seoTitle: "Muuhu Scalp Therapy Brush | 3-in-1 Red Light Scalp Care & Massage US",
  seoDescription:
    "Shop the Muuhu Scalp Therapy Brush in the US. 3-in-1 hair growth comb featuring 650nm red light therapy, micro-vibration massage, and precision serum delivery.",
  currency: market.currency,
  priceCents: 7900,
  ...
  faqs: [
    {
      ...
      answer:
        "The targeted 650nm red light penetrates deep into the scalp to energize cellular mitochondria, stimulate microcirculation, and encourage dormant follicles to support thicker, healthier-looking hair.",
    },
    {
