...
export const muuhuHairDryer: Product = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: "Yes, every Muuhu Airpro comes with a full 1-year warranty and a 90-day money-back guarantee.",
    },
  ],
  gifts: [
    {
...
export const muuhuComb: Product = {
  ...
  description: "Unlock thicker, healthier hair with the Muuhu ScalpPro. This intelligent therapy brush delivers 650nm red light to stimulate follicles, soothing micro-vibrations to boost circulation, and a precise oil applicator for maximum serum absorption without the greasy finish.",
  seoTitle: "Muuhu ScalpPro | Red Light Scalp Care & Massage",
  seoDescription: "Shop Muuhu ScalpPro. Features red light therapy, micro-vibrations, and a built-in oil applicator for a simple at-home scalp-care routine.",
  currency: market.currency,
  priceCents: 7900,
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: "We recommend using the Muuhu ScalpPro for 10-15 minutes a day, 3-4 times a week for optimal follicle stimulation and scalp health.",
    },
    {
  ...
  gifts: [],
  included: [
    { label: "Muuhu ScalpPro Device", quantity: 1, image: "/images/products/muuhu-comb/muuhu-comb-liquid-tank.webp" },
