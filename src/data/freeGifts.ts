...
export const freeGiftDetails: FreeGiftDetail[] = [
  ...
  },
  {
    ...
    seoDescription:
      "Explore the targeted Muuhu LED Torch included as a free companion gift with the Muuhu LED Mask offer.",
    intro:
      "The Muuhu LED Torch adds precision to the main mask offer. While the LED Mask gives you broad face-and-neck coverage, the torch gives you a smaller tool you can use for targeted touch-up areas and travel-friendly sessions.",
    note:
      "The current Muuhu LED Mask offer includes the LED Torch as a free bonus gift.",
  ...
  },
  {
    ...
    seoDescription:
      "Learn what is inside the Muuhu Skincare Guide delivered after your LED Mask purchase, including wavelength guidance and treatment plans.",
    intro:
      "This is not a generic PDF. It is a full Muuhu customer guide designed to help LED Mask buyers get more value out of the device from day one. It explains the wavelengths, shows how to build a routine, and turns uncertainty into a clear treatment plan.",
    note:
      "The Muuhu Skincare Guide is delivered after your LED Mask purchase. The private guide file is not published on this page.",
