export const shippingPolicyHtml = `
  ...
  <p>You will receive a confirmation email and/or text message, if you provided a mobile phone number, containing a tracking ID and a link to follow the journey of your package. You can also visit our <a href="https://muuhu.com/order-tracking">Tracking Page</a>. Please allow 1 to 2 business days for tracking information to appear.</p>
